...
namespace Dannyiania
{
    ...
    {
        #region Declares
        public static string Name = "Diana";
        ...
        static void Game_OnGameLoad(EventArgs args)
        {
            ...
            Q.SetSkillshot(0.5f, 0f, 20f, false, SkillshotType.SkillshotLine);
	        W.SetSkillshot (0.5f, 175f, 14000f, false, SkillshotType.SkillshotCircle);
            E.SetSkillshot(0.5f, 0f, 0f, false, SkillshotType.SkillshotCircle);
            //Base menu
            SF = new Menu("Dannyiania", Name, true);
            //Orbwalker and menu
            ...
            Game.PrintChat("Dannyiania loaded! By xXxXxXDannyMLGxXxXxX");
